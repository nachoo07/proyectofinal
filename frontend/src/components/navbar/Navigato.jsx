        ...
        <Toolbar disableGutters sx={{ minHeight: '64px !important' }}>
          ...
          <Typography
            ...
            sx={{
              ...
              color: '#8eeab1',
              textDecoration: 'none',
              cursor: 'pointer', // Cursor pointer para el logo
            }}
          >
            ACADEMIA
          </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            <Typography
              ...
              sx={{
                ...
                color: '#8eeab1',
                textDecoration: 'none',
                cursor: 'pointer', // Cursor pointer para el logo móvil
              }}
            >
              ACADEMIA
            </Typography>
              ...
              <Tooltip title={item.text} key={item.text}>
                <Button
                  ...
                  sx={{
                    ...
                    textTransform: 'none',
                    fontWeight: 'normal',
                    cursor: 'pointer', // Cursor pointer para los botones
                    '&:hover': {
            ...
            >
              {userSettings.map((setting, index) => (
                <MenuItem
                  ...
                  disabled={index === 0}
                  sx={{ cursor: index === 0 ? 'default' : 'pointer' }} // Pointer solo para ítems clicables
                >
          ...
          >
            ...
            {navItems.map((item) => (
              <MenuItem
                ...
                component={Link}
                to={item.url}
                sx={{ cursor: 'pointer' }} // Cursor pointer para los ítems del menú
              >
